...
//Code the routine for delay in miliseconds, using parameters byte or word
var
  delay: Word;
  aux: TPicRegister;
begin
...
delay:= _PC;
  ...
  {A better optimization must consider if only the versión of delay with word is
  used, and create a simplified version of the delay routine}
end;
