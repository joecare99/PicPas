...
ER_ERROR_DIREC := trans('Error in directive.'  , 'Error en directiva'      ,'',
                        'Fehler bei Direktive.','Помилка директиви.','Ошибка в директиве.', 'Directive erronnée.','指令错误。');
ER_UNKNO_DEVIC := trans('Unknown device: %s'   , 'Dispositivo desconocido: %s','',
                        'Unbekanntes Gerät: %s','Невизначений прилад: %s','Неизвестное устройство: %s', 'Modèle inconnu : %s','未知设备： %s');
ER_MODE_UNKNOWN:= trans('Mode unknown: %s'     , 'Modo inválido'           , '',
                        'Unbekannter Modus: %s','Невизначений режим: %s','Неизвестный режим: %s', 'Mode inconnu : %s','模式未知： %s');
ER_UNKNO_DIREC := trans('Unknown directive: %s', 'Directiva desconocida: %s','',
                        'Unbekannte Direktive: %s','Невизначена директива: %s','Неизвестная директива: %s', 'Directive inconnue : %s','未知指令： %s');
ER_ERROR_FREQ  := trans('Error in frequency.'  , 'Error en frecuencia.'    , '',
                        'Fehler bei der Frequenz.','Помилка в частоті.','Ошибка в частоте.', 'Erreur de fréquence.','频率错误。');
...
ER_SYNTAX_ERRO := trans('Syntax error.'        , 'Error de sintaxis.'      , '',
                        'Syntaxfehler.'        , 'Помилка синтаксиса.','Ошибка синтаксиса.', 'Erreur de syntaxe.','语法错误。');
ER_SYNTAX_ERR_ := trans('Syntax error: "%s"'   , 'Error de sintaxis: "%s"' , '',
                        'Syntax-Fehler: "%s"'  , 'Помилка синтаксиса: "%s"','Ошибка синтаксиса: "%s"', 'Erreur de syntaxe : "%s".','语法错误："%s"');
